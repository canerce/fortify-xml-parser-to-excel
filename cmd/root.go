...
var rootCmd = &cobra.Command{
	Use:   "fortifyxmlparsertoexcel",
	Short: "A command line application to parse and convert a fortify xml document's issues to excel",
	Long: `A command line application to parse and convert a fortify xml document's issues to excel. Example Usage:

	fortifyxmlparsertoexcel {inputfile} {outputfile}
	`,
